...
type
    ...
    TForm1 = class(TForm)
        ...
        procedure WCThread1AllTasksFinished(const Sender: TWCthread);
    private
...
procedure TForm1.WCThread1AllTasksFinished(const Sender: TWCthread);
begin
    // all tasks finished
...
begin
    // It is important to call for the normal end of the thread, otherwise the thread will be stopped without waiting.
